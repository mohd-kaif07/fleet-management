...
#         # Agar driver ya vehicle select nahi hai to validation skip
#         if not self.driver or not self.vehicle:
#             return

#         # Agar current trip complete ho chuki hai,
#         # to next assignment allow rahegi.
#         current_trip_completed = bool(self.end_date_time)

#         if current_trip_completed:
#             return
